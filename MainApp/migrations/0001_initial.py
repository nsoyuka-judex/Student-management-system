    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("guardian_email", models.EmailField(db_index=True, max_length=254)),
                (
                    "transcript",
                    models.FileField(
                        blank=True, null=True, upload_to="documents/transcripts/"
                    ),
                ),
                (
                    "id_proof",
                    models.FileField(
                        blank=True, null=True, upload_to="documents/id_proofs/"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
